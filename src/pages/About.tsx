	...
	return (
		<main className="mx-auto flex max-w-3xl flex-col gap-16 px-8 py-16">
			<header className="flex flex-col items-center gap-4 text-center">
				<h1 className="text-3xl font-semibold tracking-tight">About the cabin</h1>
				<p className="max-w-xl text-neutral-500">
					Tucked into the trees where two rivers meet, Cabin Between Rivers has been a family
					retreat for years — now open for a limited number of guests each season.
				</p>
			</header>

			{isPending && <p className="text-center text-neutral-500">Loading photos…</p>}
			{error && <p className="text-center text-sm text-red-600">Couldn't load the gallery.</p>}
			...
			<div className="flex flex-col items-center gap-4 text-center">
				<h2 className="text-xl font-semibold tracking-tight">Ready to book?</h2>
				<Link
