...
export const BookingConfirmation = (): FunctionComponent => {
	...
	return (
		<main className="mx-auto flex min-h-[60vh] max-w-lg flex-col items-center justify-center gap-4 p-8 text-center">
			{!reservationId && <p className="text-red-600">Missing reservation reference.</p>}
			...
			{status === "confirmed" && (
				<>
					<h1 className="text-2xl font-semibold text-brand-700">You're booked!</h1>
					<p className="text-neutral-600">
						Reservation #{reservationId} is confirmed. We look forward to hosting you.
					</p>
				</>
			)}
			...
			{(status === "expired" || status === "cancelled") && (
				<>
					...
					<p className="text-neutral-600">Your hold on these dates has lapsed.</p>
